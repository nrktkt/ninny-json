...
object Profile {
  implicit val toJson: ToSomeJsonObject[Profile] = ToJson.auto
  implicit val fromJson: FromJson[Profile]       = FromJson.auto
}
...
object UpdateProfile {
  implicit val json: FromJson[UpdateProfile] = FromJson.auto
}
