...
"big" should "big" in {
  case class Big(
    ...
    ai: Option[Int],
    aj: Option[Int],
    ak: Option[Int] = Some(37),
    al: Option[Int] = Some(38),
    am: Option[Int] = Some(39),
    an: Option[Int] = Some(40),
    ao: Option[Int] = Some(41),
    ap: Option[Int] = Some(42),
    aq: Option[Int] = Some(43),
    ar: Option[Int] = Some(44),
    as: Option[Int] = Some(45),
    at: Option[Int] = Some(46),
    au: Option[Int] = Some(47),
    av: Option[Int] = Some(48),
    aw: Option[Int] = Some(49),
    ax: Option[Int] = Some(50),
    ay: Option[Int] = Some(51),
    az: Option[Int] = Some(52),
    ba: Float = 53
    /*bb: Float = 54,
                      bc: Float = 55,
                      bd: Float = 56,
  ...
  val v: FromJsonAuto[Big]       = FromJsonAuto.labelledGenericFromJson
  //                                            ^
  // could not find Lazy implicit value of type io.github.kag0.ninny.FromJson[Head]
  val vv: ToJsonAuto[Big] = implicitly 
}
}
