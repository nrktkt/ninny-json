...
class JsonSpec
  ...
  "larger than 22 field classes" should "work" in {
    ...
    implicit val json: ToAndFromJson[Big] = ToAndFromJson.auto[Big]
  ...
  "annotations" should "work" in {
    ...
    implicit val toFromJson: ToAndFromJson[Example] = ToAndFromJson.auto[Example]
  ...
  }
  {
    ...
    "NullPointerBehavior" should "pass null pointers to typeclass instances by default" in {
      ...
      implicit val exampleToJson: ToSomeJsonObject[Example] = ToJson.auto[Example]
