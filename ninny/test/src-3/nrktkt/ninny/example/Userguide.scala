...
implicit val personFromJson: FromJson[Person] = FromJson.fromSome[Person](json =>
  for {
...
/*
  ...
  some kind of JSON. this is a common case.
  */
implicit val addressToJson: ToAndFromJson[Address] = ToAndFromJson.auto[Address]

implicit val personToJson: ToSomeJsonValue[Person, _] = ToJson.auto[Person]

implicit val personFromJson: FromJson[Person] = FromJson.auto[Person]
...
implicit val addressToJson: ToSomeJsonValue[Address, _] = ToJson.auto[Address]
