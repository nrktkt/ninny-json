...
implicit val toAndFromJson: ToAndFromJson[Address] = ToAndFromJson.auto[Address]
// or generate them separately
implicit val fromJson: FromJson[Person] = FromJson.auto[Person]
implicit val toJson: ToJson[Person] = ToJson.auto[Person]
